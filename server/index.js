...
mongoose_1["default"].connect("mongodb+srv://Amal:Password@1234@todocluster.fmbuo.mongodb.net/Todo_Db?retryWrites=true&w=majority", {
    useNewUrlParser: true
});
app.post("/insert", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var descr, status, todo, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                descr = req.body.description;
                status = req.body.complete;
                todo = new TodoModel_1["default"]({ description: descr, complete: status });
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
